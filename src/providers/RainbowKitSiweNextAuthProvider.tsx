...
export function RainbowKitSiweNextAuthProvider({ children, enabled, getSiweMessageOptions }: RainbowKitSiweNextAuthProviderProps) {
  ...
  const adapter = useMemo(
    () =>
      createAuthenticationAdapter({
        ...
        signOut: async () => {
          /**Do NOTHING Here, don't need to sign out after wallet disconnect*/
